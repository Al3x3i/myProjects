...
public class WebRestURIConstants {
	...
	public static final String WORKSHCEDULE_SUB_URL = "subview/{viewName}";
	public static final String WORKSHCEDULE_SUB_GET_URL = "subview/{viewName}/getAllRecords";
	public static final String WORKSHCEDULE_SUB_GETDIENST_URL = "subview/{viewName}/getRecordDetails";
	...
	public static final String WORKSCHEDULE_SUB_VVVDIENS = "vvvdienst";
}
