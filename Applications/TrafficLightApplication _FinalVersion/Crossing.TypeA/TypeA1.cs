...
namespace Crossing.TypeA
{
    ...
    public class TypeA1 : ICrossing
    {
        ...
        public Image img = Resource.crossing_type_A1;
        ...
        public TypeA1(string id, PictureBox pb)
        {
            this.Type = "A1";//needed for pedestrian logic.
        ...
        /// Note that an incoming lane is added in the crossing but also in the road to avoid long access paths.
        /// </summary>
        public void CreateLanes()
        {
            ...
            northRoad.AddIncomingLane(NIA);//to shprten the access path when needed.
        ...
        private void CreateTrafficlights(int x)
        {
            ...
            switch (x)
            {
                ...
                case 1:
                    ...
                    green.Y = (int)boundaryNorthInner - 18;
                    orange.X = (int)boundaryEastInner + 16;
                    orange.Y = (int)boundaryNorthInner - 18;
                    red.X = (int)boundaryEastInner + 2;
                    red.Y = (int)boundaryNorthInner - 18;
                    this.incominglanes[x].LocalLight.setLights(green, orange, red);
                    break;
                case 2:
